...
% plot(pos_ee.Time,pos_ee.Data(:,3),'Color',[0, 0.5, 0],'LineWidth',1.1)
% plot(eta_ee_d.Time, eta_ee_d.Data(:,3),'Color',[0, 0.5, 0],'LineStyle','--','LineWidth',1.5)
% title('Adaptive control - end-effector position and orientation $$\eta$$','interpreter','latex','fontsize',20)
% legend({'x measured', 'x desired','y measured', 'y desired','z measured', 'z desired'},'interpreter','latex','fontsize',14)
% hold off
...
% xlabel('Time [s]','interpreter','latex','fontsize',16)
% title('STA: Sliding variable $$\sigma$$','interpreter','latex','fontsize',20)
% hold off
% subplot(312)
% hold on 
...
% subplot(313)
% hold on 
% plot(sigma.Time, sigma.Data(:,7),'b','LineWidth',1.5)
% plot(sigma.Time, sigma.Data(:,8),'r','LineWidth',1.5)
% plot(sigma.Time, sigma.Data(:,9),'Color',[0, 0.5, 0],'LineWidth',1.5)
% plot(sigma.Time, sigma.Data(:,10),'Color',[0.9290, 0.6940, 0.1250],'LineWidth',1.5)
% plot(sigma.Time, sigma.Data(:,11),'Color',[0.4940, 0.1840, 0.5560],'LineWidth',1.5)
% plot(sigma.Time, sigma.Data(:,12),'Color',[0, 0.75, 0.75],'LineWidth',1.5)
% plot(sigma.Time, sigma.Data(:,13),'Color',	[0.8500, 0.3250, 0.0980],'LineWidth',1.5)
% plot(sigma.Time, sigma.Data(:,14),'Color',[0.25, 0.25, 0.25],'LineWidth',1.5)
% xlabel('Time [s]','interpreter','latex','fontsize',16)
% hold off
maxim=0.02*ones(length(sigma.Time),1);
figure()
subplot(721)
hold on
plot(sigma.Time, sigma.Data(:,1),'b','LineWidth',1.5)
plot(sigma.Time, maxim,'k--','LineWidth',0.3)
plot(sigma.Time, -maxim,'k--','LineWidth',0.3)
...
legend({'$\pm \alpha_m$'},'interpreter','latex','fontsize',14)
subplot(723)
hold on
plot(sigma.Time, sigma.Data(:,3),'Color',[0, 0.5, 0],'LineWidth',1.5)
plot(sigma.Time, maxim,'k--','LineWidth',0.3)
...
plot(sigma.Time, maxim,'k--','LineWidth',0.3)
plot(sigma.Time, -maxim,'k--','LineWidth',0.3)
grid on; hold off;   ylabel('$s_{13}$','interpreter','latex','fontsize',20)
...
figure()
hold on
plot(alpha.Time, alpha.Data(:,1),'b','LineWidth',1.5)
plot(beta.Time, beta.Data(:,1),'r','LineWidth',1.5)
legend({'$\alpha_1$', '$\beta_1$'},'interpreter','latex','fontsize',14)
xlabel('Time [s]','interpreter','latex','fontsize',14)
%title('STA: Adaptive gains $$\alpha$$ and $$\beta$$','interpreter','latex','fontsize',20)
hold off
...
for i=1:8
    ...
    if i==2
        legend({'STA $u_J$','AIDC $u_J$'},'interpreter','latex','fontsize',20)
    end
    if i==7 || i==8
         xlabel({'Time [s]'},'fontsize',14)
    end
...
for i=1:10
   ...
   if i==2
        legend({'STA $u_T$','AIDC $u_T$'},'interpreter','latex','fontsize',20)
   end
  if i==9 || i==10
         xlabel({'Time [s]'},'fontsize',14)
    end
